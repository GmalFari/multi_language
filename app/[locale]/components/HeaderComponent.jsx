    ...
    <div className="container mx-auto flex items-center justify-between px-4">
      ...
      <nav className={` hidden md:flex flex-1 justify-between items-center  list-none 
        ...
        `}>
          ...
          <li className="my-4"><a href="/">{t('nav.about')}</a></li>
          <li className="my-4"><a href="/faculties">{t('nav.academic')}</a></li>
          <li className="my-4"><a href="/academic_affairs">{t('nav.research')}</a></li>
          <li className="my-4"><a href="/academic_affairs">{t('nav.student')}</a></li>
      ...
      <nav className={`absolute  list-none right-12 mt-8
       py-2 w-48 bg-gray-200 rounded-md  md:hidden shadow-lg z-1000 
        ...
        `}>
          ...
          <li className="my-4 border-2 border-b-gray-300"><a href="/">{t('nav.about')}</a></li>
          <li className="my-4 border-2 border-b-gray-300"><a href="/faculties">{t('nav.academic')}</a></li>
          <li className="my-4 border-2 border-b-gray-300"><a href="/academic_affairs">{t('nav.research')}</a></li>
          <li className="my-4 border-2 border-b-gray-300"><a href="/academic_affairs">{t('nav.student')}</a></li>
